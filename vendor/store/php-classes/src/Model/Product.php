...
class Product extends Model {
	...
	public function save()
	{
		...
		$results = $sql->select("CALL sp_products_save(:idproduct, :desproduct, :desdescription, :vlprice, :vlwidth, :vlheight, :vllength, :vlweight, :inventory, :instock, :desurl)", array(
