...
class Payload {
     ...
     * @return string
     */
    private function getMerchantAccountInformmation()
    {
        // Domínio do Banco
    ...
    /**
     * Método responsável por retornar os valores completos da informação do campo adicional do Pix (TXID)
     * @return string
     */
    ...
    public function getPayload()
    {
        ...
        $payload = $this->getValue(self::ID_PAYLOAD_FORMAT_INDICATOR, '01').
                   $this->getMerchantAccountInformmation().
